...
if __name__ == '__main__':
    ...
    density_grid_plot_of_same_vars(Y_pred=y_pred_train, Y_obsv=y_train.to_numpy().ravel(),
                                   x_label='Reference effective precipitation \n (mm/month)',
                                   y_label='Predicted effective precipitation \n (mm/month)',
                                   plot_name=density_plot_name, savedir=plot_dir, bins=400)
    ...
    sorted_imp_vars = plot_permutation_importance(trained_model=lgbm_reg_trained,
                                                  x_test=x_test, y_test=y_test,
                                                  exclude_columns=None, output_dir=plot_dir,
                                                  plot_name=f'perm_import_{model_version}.png',
